...
public interface Etat {
     ...
     * 
     * @param modele
     *            Le modele dans lequel ouvrir le plan.
     */
     ...
     * 
     * @param fenetre
     *            La fenetre ou afficher les eventuels messages.
     * @param modele
     *            Le modele dans lequel ouvrir la demande de livraison.
     */
     ...
     * 
     * @param modele
     *            Le modele avec lequel calculer la tournee.
     * @param fenetre
     *            La fenetre ou afficher les eventuels messages.
     */
     ...
     * 
     * @param modele
     *            Le modele dans lequel ajouter les livraisons.
     * @param ldc
     *            La liste dans laquelle ajouter la commande.
     */
     ...
     * 
     * @param modele
     *            Le modele dans lequel intervertir les livraisons
     * @param listeCommandes
     *            La liste dans lequel ajouter la commande.
     */
     ...
     * 
     * @param modele
     *            Le modele dans lequel supprimer la livraison.
     * @param listeCommandes
     *            La liste dans lequel ajouter la suppression.
     */
     ...
     * 
     * @param fenetre
     *            La fenetre dans lequel afficher le message.
     * @param p
     *            Le point ou l'on a cliqué.
     */
     ...
     *            La fenetre dans lequel afficher le message.
     * @param plan
     *            Le plan sur lequel on a cliqué.
     * @param p
     *            Le point ou l'on a cliqué.
     * @param ddl
