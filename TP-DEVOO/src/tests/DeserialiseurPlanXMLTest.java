...
public class DeserialiseurPlanXMLTest {
    ...
    /**
     * A tester avec le fichier planTest Test method for
     * {@link xml.DeserialiseurPlanXML#charger(modele.Plan)}.
     * 
     * @throws ExceptionXML
     * @throws IOException
     * @throws SAXException
     ...
     */
    @Test
    public void testCharger() throws ParserConfigurationException,
	    SAXException, IOException, ExceptionXML {

	DeserialiseurPlanXML.charger(this.plan, new File(
		"src/tests/files/planTest.xml"));
	...
	for (Intersection intersection : intersections) {
		...
		for (Troncon troncon : troncons) {
			...
			assertEquals((float) troncon.getVitesseMoyenne(), 3.9,
				0.1);
			...
			assertEquals((float) troncon.getVitesseMoyenne(), 4.2,
				0.1);
		    } else {
			assertTrue(false);
		    }
		...
		for (Troncon troncon : troncons) {
			...
			assertEquals(troncon.getNomDeRue(), "v0");
			assertEquals((float) troncon.getLongueur(), 602.1, 0.1);
			assertEquals((float) troncon.getVitesseMoyenne(), 4.1,
				0.1);
			...
			assertEquals((float) troncon.getVitesseMoyenne(), 3.8,
				0.1);
			...
			assertEquals((float) troncon.getVitesseMoyenne(), 4.0,
				0.1);
		    } else {
			assertTrue(false);
		    }
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planBaliseTest.xml"));
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planAttributTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planNoeudManquantTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	    ...
	    assertThat(
		    e.getMessage(),
		    CoreMatchers
			    .containsString("Le contenu de l'élément 'Reseau' n'est pas complet. L'un des éléments '{Noeud}' est attendu."));
	}
    }
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planTronconManquantTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	    ...
	    assertThat(
		    e.getMessage(),
		    CoreMatchers
			    .containsString("Le contenu de l'élément 'Noeud' n'est pas complet. L'un des éléments '{LeTronconSortant}' est attendu."));
	}
    }
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planDeuxTronconsTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planUniqueIdTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planDestinationAbsenteTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	    ...
	    assertThat(
		    e.getMessage(),
		    CoreMatchers
			    .containsString("La clé 'referenceTroncon' ayant la valeur '"));
	    assertThat(
		    e.getMessage(),
		    CoreMatchers
			    .containsString("' est introuvable pour la contrainte d'identité de l'élément 'Reseau'."));
	}
    }
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planNomRueTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	    ...
	    assertThat(
		    e.getMessage(),
		    CoreMatchers
			    .containsString("La valeur '', ayant pour longueur '0', n'est pas un facet valide par rapport à minLength '1' pour le type 'nonEmptyString'."));
	}
    }
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planVitessePositiveTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	    ...
	    assertThat(
		    e.getMessage(),
		    CoreMatchers
			    .containsString("' n'est pas un facet valide par rapport au modèle '\\d+(,\\d+)?' pour le type 'positive-decimal'."));
	}
    }
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planLongueurPositiveTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planBoucleTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	    ...
	    assertThat(
		    e.getMessage(),
		    CoreMatchers
			    .containsString("Un tronçon ne peut avoir la même intersection comme origine et destination."));
	}
    }
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planCoordonneesUniqueTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
	...
	try {
	    DeserialiseurPlanXML.charger(this.plan, new File(
		    "src/tests/files/planIntersectionPositiveTest.xml"));
	    fail("Devrait avoir lancé XMLException");
	} catch (ParserConfigurationException e) {
	    fail("Devrait avoir lancé XMLException");
	    e.printStackTrace();
