...
public class IntersectionTest {
    ...
    /**
     * Test method for
     * {@link modele.Intersection#Intersection(java.lang.Integer, java.lang.Integer, java.lang.Integer)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link modele.Intersection#rechercherTroncon(modele.Intersection)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link modele.Intersection#ajouteTronconEntrant(modele.Troncon)}.
     */
    @Test
	...
	float longueur = (float) 100.3;
	float vitesse = (float) 20.7;
	Troncon troncon = new Troncon(nomRue, vitesse, longueur, depart,
		arrivee);
    ...
    /**
     * Test method for
     * {@link modele.Intersection#ajouteTronconSortant(modele.Troncon)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link modele.Intersection#contient(java.awt.Point, float, float)}.
     */
    @Test
	...
	Troncon troncon1 = new Troncon(nomRue1, vitesse1, longueur1, depart,
		arrivee1);
	String nomRue2 = "k2";
	float longueur2 = (float) 189.3;
	float vitesse2 = (float) 34.7;
	Troncon troncon2 = new Troncon(nomRue2, vitesse2, longueur2, depart,
		arrivee2);
	...
	Map<Intersection, Integer> intersectionsVoisines = depart
		.getIntersectionsVoisines();

	for (Map.Entry<Intersection, Integer> intersectionVoisine : intersectionsVoisines
		.entrySet()) {
