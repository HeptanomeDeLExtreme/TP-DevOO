...
public class ItineraireTest {
    ...
    /**
     * Test method for
     * {@link modele.Itineraire#Itineraire(int, java.util.List, modele.Livraison, modele.Livraison)}
     * .
     */
    @Test
	...
	assertTrue(itineraire.getArrivee().getAdresse()
		.equals(arrivee.getAdresse()));

	assertEquals(itineraire.getDepart().getId(), depart.getId());
	assertTrue(itineraire.getDepart().getAdresse()
		.equals(depart.getAdresse()));
