...
public class Horaire {
	...
	String s = " " + this.heure + "h " + this.minute + "m " + this.seconde
		+ "s";
	return s;
    }
	...
	// System.out.println("nombre de secondes de l'horaire de début de la fenetre de livraison : "
	// + duree2);
	boolean resultat = false;
	if (duree1 <= duree2) {
