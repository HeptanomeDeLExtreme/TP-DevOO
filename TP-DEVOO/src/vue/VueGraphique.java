...
/**
 * Represente la zone de dessin de l'IHM
 */
public class VueGraphique extends JPanel implements Observer {

    /**
     * L'echelel sur l'axe des X.
     */
    private float echelleX;
    /**
     * L'echelel sur l'axe des Y.
     */
     ...
     * 
     * @param modele
     *            Le modele avec lequel interagir.
     * @param fenetreIHM
    ...
    /**
     * Remplit la zone graphique avec les infos adéquates.
     */
	...
	if (listInter != null && listInter.size() > 0) {
	    ...
	    List<FenetreTemporelle> listeFenetre = demandeDeLivraison
		    .getFenetres();
