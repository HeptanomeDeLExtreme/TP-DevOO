...
public class LivraisonTest {
	...
	troncon1 = new Troncon(nomRue1, vitesse1, longueur1, adresse,
		destination1);
	...
	troncon2 = new Troncon(nomRue2, vitesse2, longueur2, adresse,
		destination2);
    ...
    /**
     * Test method for
     * {@link modele.Livraison#Livraison(int, modele.Intersection)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link modele.Livraison#Livraison(int, modele.Client, modele.Intersection, modele.FenetreTemporelle)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link modele.Livraison#rechercherCout(java.util.Map, modele.Livraison)}.
     */
    @Test
	...
	assertEquals(
		livraison.rechercherCout(mapIntersectionsGraphe, livraison), 1);
    }

    /**
     * Test method for
     * {@link modele.Livraison#rechercherTroncons(java.util.Map, modele.Livraison)}
     * .
     */
    @Test
	...
	List<Troncon> troncons = livraison.rechercherTroncons(
		mapIntersectionsGraphe, livraison);
    ...
    /**
     * Test method for
     * {@link modele.Livraison#calculerPlusCourtsChemins(modele.GraphePondere)}.
     */
    @Test
	...
	Map<Integer, Intersection> mapCorrespondancePlan = graphePondere
