...
public class Controleur {
    ...
    /**
     * Permet d'afficher un message dans la zone affectée dans la fenetre
     * utilisateur.
     * 
     * @param Le
     *            message a affiché.
	...
	this.etatCourant.genererFeuilleRoute(this.fenetre,
		this.modele.getTournee());
    }
     ...
     * 
     * @param Le
     *            point sur lequel on a clique.
     */
    public void clicGauche(Point p) {
	this.etatCourant.clicGauche(fenetre, this.modele.getPlan(), p,
		this.modele.getDemandeDeLivraison());
    }
