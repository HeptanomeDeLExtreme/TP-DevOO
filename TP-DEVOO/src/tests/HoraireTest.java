...
public class HoraireTest {
    ...
    /**
     * Test method for
     * {@link modele.Horaire#isInFenetreTemporelle(modele.Horaire, modele.Horaire)}
     * .
     */
    @Test
    public void testIsInFenetreTemporelle() {
	Horaire horaire = new Horaire(8, 30, 0);
	assertTrue(horaire.isInFenetreTemporelle(new Horaire(7, 50, 30),
		new Horaire(8, 40, 0)));
	assertTrue(!horaire.isInFenetreTemporelle(new Horaire(7, 50, 30),
		new Horaire(8, 20, 0)));
	assertTrue(!horaire.isInFenetreTemporelle(new Horaire(9, 50, 30),
		new Horaire(10, 20, 0)));
	assertTrue(horaire.isInFenetreTemporelle(new Horaire(8, 30, 0),
		new Horaire(10, 20, 0)));
	assertTrue(horaire.isInFenetreTemporelle(new Horaire(7, 30, 0),
		new Horaire(8, 30, 0)));
	assertTrue(!horaire.isInFenetreTemporelle(new Horaire(8, 30, 0),
		new Horaire(6, 30, 0)));
    }
