...
public class Intersection {
    ...
    /**
     * Recherche toutes les intersections accessibles depuis l'intersection, par
     * l'emprunt d'un seul troncon.
     * 
     * @return Map contenant toutes les intersections atteignables depuis cette
     *         intersection, et le cout associé du trajet.
     */
    ...
    /**
     * Verifie par rapport a un clic utilisateur si il y a une intersection sur
     * ce point
     * 
     * @param p
     *            Point clique par l'utilisateur
     * @param echelleX
     *            Echelle de la fenetre sur l'axe X
     * @param echelleY
     *            Echelle de la fenetre sur l'axe Y
     * @return
     */
